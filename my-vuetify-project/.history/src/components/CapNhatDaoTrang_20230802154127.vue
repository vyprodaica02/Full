...
export default {
  ...
  methods: {
    ...
    saveChanges(editedData) {
      // Kiểm tra xem editedData có chứa trường id không
      if (
        !Object.prototype.hasOwnProperty.call(editedData, "daotrangid") ||
        editedData.daotrangid === null ||
        editedData.daotrangid === ""
      ) {
      ...
      this.$store
        .dispatch("saveChanges", editedData) // Sử dụng this.$store.dispatch để gọi action
        .then(() => {
